...
def option1():
    if notTakenTest == True:
        newX = startPoint[0] + sqrt(300)
        newY = startPoint[1] + 10
        turnsP1 = turnsP1 - 1
    return newX, newY, turnsP1

    newX2 = startPoint[0] - sqrt(300)
    newY2 = startPoint[1] + 10

    newX3 = startPoint[0] - sqrt(300)
    newY3 = startPoint[1] - 10

    newX4 = startPoint[0] + sqrt(300)
    newY4 = startPoint[1] - 10

    newX5 = startPoint[0]
    newY5 = startPoint[1] + 20

    newX6 = startPoint[0]
    newY6 = startPoint[1] - 20
